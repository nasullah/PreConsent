...
<body>
	...
	<section id="edit-consentStatus" class="first">
		...
		<g:form method="post" class="form-horizontal" role="form" >
			<g:hiddenField name="id" value="${consentStatusInstance?.id}" />
			<g:hiddenField name="version" value="${consentStatusInstance?.version}" />
