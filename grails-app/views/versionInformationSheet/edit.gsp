...
<body>
	...
	<section id="edit-versionInformationSheet" class="first">
		...
		<g:form method="post" class="form-horizontal" role="form" >
			<g:hiddenField name="id" value="${versionInformationSheetInstance?.id}" />
			<g:hiddenField name="version" value="${versionInformationSheetInstance?.version}" />
