...
<body>
	...
	<section id="edit-consentVersion" class="first">
		...
		<g:form method="post" class="form-horizontal" role="form" >
			<g:hiddenField name="id" value="${consentVersionInstance?.id}" />
			<g:hiddenField name="version" value="${consentVersionInstance?.version}" />
