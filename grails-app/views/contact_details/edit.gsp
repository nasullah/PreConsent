...
<body>
	...
	<section id="edit-contact_details" class="first">
		...
		<g:form method="post" class="form-horizontal" role="form" >
			<g:hiddenField name="id" value="${contact_detailsInstance?.id}" />
			<g:hiddenField name="version" value="${contact_detailsInstance?.version}" />
